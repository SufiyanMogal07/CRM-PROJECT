...
<main class="main-body p-3 d-flex flex-column">
    <div class="main-container p-5">
        ...
        <!-- Add Task -->
        <div class="modal fade" id="assignTaskInput" tabindex="-1" aria-labelledby="inputModalLabel" >
        ...
        <!-- Edit Task -->
        <div class="modal fade" id="editTaskInput" tabindex="-1" aria-labelledby="inputModalLabel" >
            <div class="modal-dialog modal-dialog-centered  modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="inputModalLabel">Enter Task Details</h5>
